...
HP.CustomAttributeRetrievalCallbacks = Object.create(null);
...
HP.addCustomAttribute = (attributeId, attributeName, callback) => {
    ...
    // also register custom attribute to current matcher
    if (ProtocolEngine instanceof HP.ProtocolEngine) {
        const matcher = ProtocolEngine.getDefaultMatcher();
        matcher.addCustomAttributeRetrievalCallback(attributeId, attributeName, callback);
    }
};
