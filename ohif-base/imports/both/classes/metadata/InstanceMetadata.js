...
export class InstanceMetadata extends Metadata {
    ...
    getTagValue(tagOrProperty, defaultValue) {
        /**
         * This method should be overriden by specialized classes in order to allow client libraries or viewers to take advantage of the Study Metadata API.
         * Please use OHIFInstanceMetadata class as an example.
         */
        throw new Error('InstanceMetadata::getTagValue is not overriden. Please, override it in a specialized class. See OHIFInstanceMetadata for example');
    }
    ...
    tagExists(tagOrProperty) {
         ...
         */
        throw new Error('InstanceMetadata::tagExists is not overriden. Please, override it in a specialized class. See OHIFInstanceMetadata for example');
    }
    ...
    getImageId(frame) {
         ...
         * Please override this method
         */
        throw new Error('InstanceMetadata::getImageId is not overriden. Please, override it in a specialized class. See OHIFInstanceMetadata for example');
    }
