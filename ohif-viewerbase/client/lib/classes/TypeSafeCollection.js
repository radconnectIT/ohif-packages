...
export class TypeSafeCollection extends EventSource {

    constructor() {

        // Necessary now since this class inherits from EventSource class
        super();
    ...
    updateById(id, payload) {
        ...
        if (this._reentrancy.update) {
            throw new Error('TypeSafeCollection::updateById Reentrancy Error');
        }
    ...
    update(payload) {
        ...
        if (this._reentrancy.update) {
            throw new Error('TypeSafeCollection::update Reentrancy Error');
        }
    ...
    insert(payload) {
        ...
        if (this._reentrancy.insert) {
            throw new Error('TypeSafeCollection::insert Reentrancy Error');
        }
        ...
        try {
            ...
            if (!found) {
                ...
                this._invalidate();
                this.dispatch(EVENT_INSERT, { id, data: payload });
            }
        } finally {
            this._reentrancy.insert = false;
        }
    ...
    removeAll() {
        ...
        if (this._reentrancy.remove) {
            throw new Error('TypeSafeCollection::removeAll Reentrancy Error');
        }
