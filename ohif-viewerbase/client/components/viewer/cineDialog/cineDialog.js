...
Template.cineDialog.onCreated(() => {
    ...
    instance.api = {
        ...
        cineFirst: () => viewportUtils.switchToImageByIndex(0),
        cineLast: () => viewportUtils.switchToImageByIndex(-1),
        cinePrevious: () => viewportUtils.switchToImageRelative(-1),
        cineNext: () => viewportUtils.switchToImageRelative(1),
        cineSlowDown: () => {
    ...
    instance.autorun(() => {
        ...
        Tracker.afterFlush(() => {
            ...
            let playClipData;
            try {
                playClipData = cornerstoneTools.getToolState(element, 'playClip');
